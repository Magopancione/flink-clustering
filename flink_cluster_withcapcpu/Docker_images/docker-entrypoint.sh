...
TASKMANAGER_CPU=${TASKMANAGER_CPU:-1}
echo "TASKMANAGER_CPU=$TASKMANAGER_CPU"
echo $TASKMANAGER_CPU > /taskmanager.valude.txt
...
if [ "$1" = "help" ]; then
    ...
    TASK_MANAGER_NUMBER_OF_TASK_SLOTS=${TASK_MANAGER_NUMBER_OF_TASK_SLOTS:-$$TASKMANAGER_CPU}
